...
import loanAnnotationsRouter from "./loanAnnotations";
...
router.use("/loans/annotations", requireAuth, loanAnnotationsRouter);
router.use("/credentials", requireAuth, credentialsRouter);
router.use("/ltv", requireAuth, ltvRouter);
