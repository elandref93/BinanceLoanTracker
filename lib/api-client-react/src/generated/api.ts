...
export const getListLoanTransactionsUrl = (params: ListLoanTransactionsParams,) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0 ? `/api/loans/transactions?${stringifiedParams}` : `/api/loans/transactions`
}
 ...
 */
export const listLoanTransactions = async (params: ListLoanTransactionsParams, options?: RequestInit): Promise<LoanTransactionsResponse> => {

  return customFetch<LoanTransactionsResponse>(getListLoanTransactionsUrl(params),
  {
    ...options,
    method: 'GET'
...
export const getListLoanTransactionsQueryKey = (params?: ListLoanTransactionsParams,) => {
    return [
    `/api/loans/transactions`, ...(params ? [params] : [])
    ] as const;
    }


export const getListLoanTransactionsQueryOptions = <TData = Awaited<ReturnType<typeof listLoanTransactions>>, TError = ErrorType<unknown>>(params: ListLoanTransactionsParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listLoanTransactions>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getListLoanTransactionsQueryKey(params);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof listLoanTransactions>>> = ({ signal }) => listLoanTransactions(params, { signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listLoanTransactions>>, TError, TData> & { queryKey: QueryKey }
}

export type ListLoanTransactionsQueryResult = NonNullable<Awaited<ReturnType<typeof listLoanTransactions>>>
export type ListLoanTransactionsQueryError = ErrorType<unknown>
...
export function useListLoanTransactions<TData = Awaited<ReturnType<typeof listLoanTransactions>>, TError = ErrorType<unknown>>(
 params: ListLoanTransactionsParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listLoanTransactions>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getListLoanTransactionsQueryOptions(params,options)
